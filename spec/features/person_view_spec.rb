...
describe 'the person view', type: :feature do
  ...
  describe 'email_addresses' do
    ...
    before(:each) do
      ...
      person.email_addresses.create(address: "bobjones@example2.com")
      visit person_path(person)
    end
    ...
    it 'adds a new email address' do
      page.click_link('new_email_address')
      page.fill_in('Address', with: 'bobby@example.com')
    ...
    it 'edits a email address' do
      ...
      page.fill_in('Address', with: 'bobby@yahoo.com')
      page.click_button('Update Email address')
      expect(current_path).to eq(person_path(person))
      expect(page).to have_content('bobby@yahoo.com')
